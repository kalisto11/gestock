        ...
        <?php if($_SESSION['user']['niveau'] >= GESTIONNAIRE) : ?><div class="col-md-8"><?php endif; ?>
            ...
            <?php if (isset($pagination->currentPage)) : ?>
                ...
                <?php if ($pagination->currentPage > 1):?>
                    <a href="/gestock/fournisseurs/liste/?page=<?= $pagination->currentPage - 1 ?>" title="Page précédente"><img src="images/icones/precedent.png" alt="Page précédente" class="page-icone"></a>
                <?php endif ?>
                <?php if ($pagination->currentPage < $pagination->pages):?>
                    <a href="/gestock/fournisseurs/liste/?page=<?= $pagination->currentPage + 1 ?>" class="ml-auto" title="Page suivante"><img src="images/icones/suivant.png" alt="Page suivante" class="page-icone"></a>
                <?php endif ?>
            </div>
            <?php endif ; ?>

            <div class="zonegrise font-weight-bold px-4 w-75">
                <div class="row">
                    <div class="text-left col-sm-10">
                        <h5>Nombre total de fournisseurs : </h5>
                    </div>
