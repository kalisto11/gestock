            ...
            <div class="container-fluid">
                <form method="post" action="/gestock/postes/traitement-poste">
                    <div class="form-group">
                        ...
                        <input class="form-control input-sm" type="text" name="nomPoste" value="<?php if (isset($currentPoste->id)){echo $currentPoste->nom;} ?>" placeholder="Saisir le nom du nouveau poste ici" required>
                    </div>
