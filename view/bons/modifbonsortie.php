          ...
          <div class="row row-color m-2">
            ...
            <div class="col-3">
              <div class="form-group">
                ...
                <input type="number" name="quantite<?= $i ?>" id="quantite<?= $i ?>" value="<?= $dotation->quantite ?>" class="form-control form-control-sm quantiteArticle" placeholder="Saisir un nombre">
              </div>
            </div>
            ...
            <div class="col-3">
              <div class="form-group">
                ...
                <input type="number" name="prix<?= $i ?>" id="prix<?= $i ?>" value="<?= $dotation->prix ?>" class="form-control form-control-sm prixArticle" placeholder="Saisir le prix unitaire">
              </div>
            </div>
            ...
            <div class="col-2">
              <div class="form-group">
                ...
                <input type="text" name="total<?= $i ?>" id="total<?= $i ?>" value="<?= $dotation->total ?>" class="form-control form-control-sm totalArticle" value="" disabled>
              </div>
            </div>
